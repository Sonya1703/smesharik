...
form.addEventListener('submit', (event) => {
    ...
    if (y === 0) {
        y = "пока никто";
        document.getElementById("descriptionn").innerText = "Вы не ответили ни на один вопрос. Неужели вам не интересно, кто вы из смешариков?";
        ...
        y = "Крош";
        document.getElementById("descriptionn").innerText = "Вы активный и жинерадостный человек. Общение - важная часть вашей жизни. Иногда вам свойственно проявление чувствительности и сострадания";
        ...
        y = "Ёжик";
        document.getElementById("descriptionn").innerText = "Вы неторопливы и рассудительны. Всегда стремитесь помочь близким и создать приятную атмосферу вокруг. Иногда бываете черезчур стеснительными и тихими";
        ...
        y = "Пин";
        document.getElementById("descriptionn").innerText = "Вы сдержанны в эмоциях, весьма молчаливы и немного чопорны. Но это лишь на первый взгляд. К решению проблем вы подходите с креативностью. Вы дорожите друзьями и очень привязываетесь к близким.";
        ...
        y = "Карыч";
         document.getElementById("descriptionn").innerText = "У вас спокойный и строгий характер. За плечами немалый жизненный опыт и множество интересных воспоминаний. Вы любитель поностальгировать и, при случае, поделиться советом.";
        ...
        y = "Нюша";
        document.getElementById("descriptionn").innerText = "У вас весьма переменчивый характер. Вам важна ваша внешность и мнение окружающих о вас. Во многих делах стремитесь к идеалу и проявляете качества перфекциониста.";
